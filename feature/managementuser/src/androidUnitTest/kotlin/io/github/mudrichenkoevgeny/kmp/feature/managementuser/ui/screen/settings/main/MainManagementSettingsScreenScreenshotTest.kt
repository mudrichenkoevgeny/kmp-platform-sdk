...
class MainManagementSettingsScreenScreenshotTest {

    @Test
    fun capture() = runComposeUiTest {
        val component = MainManagementSettingsComponentMock()
        ...
        onRoot().captureAppScreen(
            testInstance = this@MainManagementSettingsScreenScreenshotTest,
            stateName = "Default"
        )
    }
}
