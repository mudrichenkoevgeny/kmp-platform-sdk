...
class AuditEventsScreenScreenshotTest(
    private val stateName: String,
    private val state: AuditEventsScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = AuditEventsComponentMock(initialState = state)
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = AuditEventsPreviewProvider()
