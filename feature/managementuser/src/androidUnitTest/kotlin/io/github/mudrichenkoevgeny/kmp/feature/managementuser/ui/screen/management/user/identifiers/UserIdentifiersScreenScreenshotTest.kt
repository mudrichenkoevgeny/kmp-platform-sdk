...
class UserIdentifiersScreenScreenshotTest(
    ...
    private val state: UserIdentifiersScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = UserIdentifiersComponentMock(initialState = state)
        ...
        if (state is UserIdentifiersScreenState.Loading) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = UserIdentifiersPreviewProvider()
