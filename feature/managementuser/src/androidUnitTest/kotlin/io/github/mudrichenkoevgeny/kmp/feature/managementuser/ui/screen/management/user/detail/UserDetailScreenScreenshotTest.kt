...
class UserDetailScreenScreenshotTest(
    private val stateName: String,
    private val state: UserDetailScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = UserDetailComponentMock(initialState = state)
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = UserDetailPreviewProvider()
