...
class UsersManagementRootScreenScreenshotTest {

    @Test
    fun capture() = runComposeUiTest {
        val component = UsersManagementRootComponentMock()

        setContent {
            ComponentTestHarness {
                UsersManagementRootScreen(component)
            }
        }

        onRoot().captureAppScreen(
            testInstance = this@UsersManagementRootScreenScreenshotTest,
            stateName = "Main"
        )
    }
}
