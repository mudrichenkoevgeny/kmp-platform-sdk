...
interface ManagementUserApi {
     ...
     * @param sortBy Field to sort by (last_login_at, last_active_at, scheduled_permanent_deletion_at, account_lockout_type, temporary_lockout_until, created_at, updated_at).
