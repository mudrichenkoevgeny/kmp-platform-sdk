...
| `...user.usecase` | Atomic logic: Management Auth, Session, User, and Config UseCases. |
| `...user.mock` | Mocks for tests: UseCase and Repository mocks for management context. |
