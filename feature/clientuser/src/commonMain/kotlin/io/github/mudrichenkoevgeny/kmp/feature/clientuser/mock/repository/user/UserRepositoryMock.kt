package io.github.mudrichenkoevgeny.kmp.feature.clientuser.mock.repository.user
...
@InternalApi
open class UserRepositoryMock : UserRepository {
    ...
    override suspend fun scheduleUserDeletion(): AppResult<UserDetails> = handleUpdate()
