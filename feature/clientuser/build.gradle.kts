...
//    androidLibrary {
//        namespace = "io.github.mudrichenkoevgeny.kmp.feature.clientuser"
...
compose.resources {
    publicResClass = true
    packageOfResClass = "io.github.mudrichenkoevgeny.kmp.feature.clientuser"
}