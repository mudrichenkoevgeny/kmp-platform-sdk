...
import io.github.mudrichenkoevgeny.kmp.feature.user.mock.network.api.user.UserApiMock
...
class UserRepositoryImplTest {
    ...
    private val userApi = UserApiMock()
    private val webSocketService = WebSocketServiceMock()

    private fun createRepository(scope: TestScope): UserRepositoryImpl {
