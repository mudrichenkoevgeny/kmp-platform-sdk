...
@InternalApi
class LoginByEmailUseCaseMock : LoginByEmailUseCase(
    ...
    override suspend fun execute(email: String, password: String): AppResult<AuthData> =
        resultProvider(email, password)
}
