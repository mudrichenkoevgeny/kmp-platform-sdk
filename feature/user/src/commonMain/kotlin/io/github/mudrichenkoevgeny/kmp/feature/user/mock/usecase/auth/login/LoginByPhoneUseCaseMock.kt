...
@InternalApi
class LoginByPhoneUseCaseMock : LoginByPhoneUseCase(
    ...
    override suspend fun execute(phoneNumber: String, confirmationCode: String): AppResult<AuthData> =
        resultProvider(phoneNumber, confirmationCode)
}
