...
class UnlockOtpScreenScreenshotTest(
    private val stateName: String,
    private val state: UnlockOtpScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = UnlockOtpComponentMock(initialState = state)
        ...
        onRoot().captureAppScreen(
            testInstance = this@UnlockOtpScreenScreenshotTest,
            stateName = stateName
        )
    }
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = UnlockOtpPreviewProvider()
