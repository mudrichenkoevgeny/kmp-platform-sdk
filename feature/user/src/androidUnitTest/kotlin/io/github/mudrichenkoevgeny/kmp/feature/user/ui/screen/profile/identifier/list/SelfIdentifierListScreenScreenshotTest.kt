...
class SelfIdentifierListScreenScreenshotTest(
    private val stateName: String,
    private val state: SelfIdentifierListScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = SelfIdentifierListComponentMock(initialState = state)
        ...
        onRoot().captureAppScreen(
            testInstance = this@SelfIdentifierListScreenScreenshotTest,
            stateName = stateName
        )
    }
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = SelfIdentifierListPreviewProvider()
