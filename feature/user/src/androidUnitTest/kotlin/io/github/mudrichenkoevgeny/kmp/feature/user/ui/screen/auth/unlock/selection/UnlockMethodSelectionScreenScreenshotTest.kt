...
class UnlockMethodSelectionScreenScreenshotTest(
    private val stateName: String,
    private val state: UnlockMethodSelectionScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = UnlockMethodSelectionComponentMock(initialState = state)
        ...
        onRoot().captureAppScreen(
            testInstance = this@UnlockMethodSelectionScreenScreenshotTest,
            stateName = stateName
        )
    }
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = UnlockMethodSelectionPreviewProvider()
