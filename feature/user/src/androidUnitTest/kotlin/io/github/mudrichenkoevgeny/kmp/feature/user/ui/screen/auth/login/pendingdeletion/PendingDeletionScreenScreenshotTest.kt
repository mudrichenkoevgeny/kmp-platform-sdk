...
class PendingDeletionScreenScreenshotTest(
    private val stateName: String,
    private val state: PendingDeletionScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = PendingDeletionComponentMock(initialState = state)
        ...
        onRoot().captureAppScreen(
            testInstance = this@PendingDeletionScreenScreenshotTest,
            stateName = stateName
        )
    }
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = PendingDeletionPreviewProvider()
