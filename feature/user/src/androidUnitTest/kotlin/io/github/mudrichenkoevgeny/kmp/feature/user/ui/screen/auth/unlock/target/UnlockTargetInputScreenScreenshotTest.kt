...
class UnlockTargetInputScreenScreenshotTest(
    private val stateName: String,
    private val state: UnlockTargetInputScreenState
) {

    @Test
    fun capture() = runComposeUiTest {
        val component = UnlockTargetInputComponentMock(initialState = state)
        ...
        onRoot().captureAppScreen(
            testInstance = this@UnlockTargetInputScreenScreenshotTest,
            stateName = stateName
        )
    }
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            val provider = UnlockTargetInputPreviewProvider()
