...
//    androidLibrary {
//        namespace = "io.github.mudrichenkoevgeny.kmp.samplemanagement.app"
...
//            baseName = "SampleManagementComposeApp"
//            isStatic = true
//        }
//    }
...
compose.resources {
    publicResClass = true
    packageOfResClass = "io.github.mudrichenkoevgeny.kmp.samplemanagement.app"
}

val env = project.findProperty("app.env")?.toString() ?: "dev"

buildConfig {
    packageName("io.github.mudrichenkoevgeny.kmp.samplemanagement")
